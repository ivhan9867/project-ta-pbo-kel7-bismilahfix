...
public class MagnusForge extends Mercenary {
    ...
    protected void initStats() {
        stats.setBase(StatType.MAX_HP,       200);
        ...
        stats.setBase(StatType.PHYSICAL_ATK, 42); // ATK tertinggi di semua merc
        stats.setBase(StatType.ENERGY_ATK,   20);
        stats.setBase(StatType.PHYSICAL_DEF, 22);
        stats.setBase(StatType.CYBER_DEF,    10);
        stats.setBase(StatType.ENERGY_DEF,   15);
