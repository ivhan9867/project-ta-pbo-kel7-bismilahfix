...
<svg width="860" height="120" viewBox="0 0 860 120" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" style="stop-color:#0A0514"/>
      <stop offset="50%" style="stop-color:#1A0830"/>
      <stop offset="100%" style="stop-color:#0A0514"/>
    </linearGradient>
    <linearGradient id="gold" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" style="stop-color:#FFB830"/>
      <stop offset="50%" style="stop-color:#FFD700"/>
      <stop offset="100%" style="stop-color:#C8860A"/>
    </linearGradient>
    <filter id="glow">
  ...
  <!-- Background -->
  <rect width="860" height="120" fill="url(#bg)" rx="12"/>
  <rect width="860" height="2" y="0" fill="url(#gold)" rx="1"/>
  <rect width="860" height="2" y="118" fill="url(#gold)" rx="1"/>
  <!-- Animated hex decorations -->
  <text x="30" y="68" font-size="32" fill="#AA44FF" opacity="0.3" filter="url(#glow)">⬡
    <animate attributeName="opacity" values="0.2;0.6;0.2" dur="2s" repeatCount="indefinite"/>
  </text>
  <text x="800" y="68" font-size="32" fill="#AA44FF" opacity="0.3" filter="url(#glow)">⬡
    <animate attributeName="opacity" values="0.6;0.2;0.6" dur="2s" repeatCount="indefinite"/>
  </text>
  <!-- Title -->
  <text x="430" y="52" text-anchor="middle" font-family="Courier New, monospace"
        font-size="26" font-weight="bold" fill="url(#gold)" filter="url(#glow)">
    MYTHIC ITEM OBTAINED
  </text>
  <!-- Subtitle animated -->
  <text x="430" y="80" text-anchor="middle" font-family="Courier New, monospace"
        font-size="13" fill="#AA66FF">
    ✦ Roguelite RPG Turn-Based · Nusantara Dark Fantasy ✦
    <animate attributeName="opacity" values="0.6;1;0.6" dur="3s" repeatCount="indefinite"/>
  </text>
  <!-- Version -->
  <text x="430" y="104" text-anchor="middle" font-family="Courier New, monospace"
        font-size="11" fill="#C8860A" opacity="0.7">
    v1.0.4 · FULL RELEASE · Kelompok 7 · BismilahFIX · 2026
  </text>
</svg>
